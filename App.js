...
function checkPalindromeForAllDateFormats(date) {
  ...
  for (let i = 1 ; i < listOfPalindromes.length; i++){
    if (checkPalidrome(listOfPalindromes[i])){
      flag = true;
      break;
    }
  }
...
function clickHandler(e) {
  ...
  if (bdayStr !== ""){
    ...
    if(isPalindrome){
      ...
      output.innerHTML = `The next palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed it by ${counter} days!`
    }
  }
